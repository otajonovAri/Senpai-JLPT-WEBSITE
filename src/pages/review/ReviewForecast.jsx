...
const styles = {
  ...
  summaryCard: { background: 'var(--bg-card)', borderRadius: 14, padding: 16, textAlign: 'center', border: '2px solid var(--border)' },
  summaryNum: { fontSize: 24, fontWeight: 700, color: 'var(--text)', marginTop: 4 },
  summaryLabel: { fontSize: 11, color: 'var(--text-light)' },
  chartCard: { background: 'var(--bg-card)', borderRadius: 16, padding: 20, border: '2px solid var(--border)' },
  ...
  listItem: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 14px', background: 'var(--bg-card)', borderRadius: 10, border: '2px solid var(--border)' },
