...
const styles = {
  ...
  detailsCard: { background: 'var(--bg-card)', borderRadius: 14, padding: 16, border: '2px solid var(--border)' },
  ...
  cancelModal: { textAlign: 'center', background: 'var(--bg-card)', borderRadius: 16, padding: 24, border: '2px solid var(--border)', boxShadow: 'var(--shadow-lg)' },
  ...
  freeCard: { textAlign: 'center', background: 'var(--bg-card)', borderRadius: 16, padding: 32, border: '2px solid var(--border)' },
