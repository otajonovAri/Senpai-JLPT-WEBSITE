...
const styles = {
  ...
  featureCard: { display: 'flex', alignItems: 'center', gap: 10, padding: '12px 14px', background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)' },
  ...
  planCard: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 18px', background: 'var(--bg-card)', borderRadius: 14, border: '2px solid var(--border)', marginBottom: 8, cursor: 'pointer', position: 'relative' },
