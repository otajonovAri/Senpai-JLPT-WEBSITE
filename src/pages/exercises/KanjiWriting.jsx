...
const styles = {
  ...
  strokeItem: { width: 32, height: 32, borderRadius: 10, background: 'var(--bg)', border: '2px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 700, color: 'var(--text-light)' },
  ...
  actionBtn: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5, padding: 10, borderRadius: 10, background: 'var(--bg)', border: '2px solid var(--border)', color: 'var(--text-light)', fontSize: 12, fontWeight: 600, cursor: 'pointer' },
  ...
  secBtn: { display: 'flex', alignItems: 'center', gap: 6, padding: '13px 18px', borderRadius: 12, background: 'var(--bg)', border: '2px solid var(--border)', color: 'var(--text)', fontSize: 13, fontWeight: 500, cursor: 'pointer' },
};
