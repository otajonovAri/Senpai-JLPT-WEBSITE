...
const styles = {
  ...
  contactCard: { textAlign: 'center', padding: 16, background: 'var(--bg-card)', borderRadius: 14, border: '1px solid var(--border-light)' },
  ...
  faqItem: { background: 'var(--bg-card)', borderRadius: 12, border: '1px solid var(--border-light)', overflow: 'hidden', cursor: 'pointer' },
