...
const styles = {
  ...
  backBtn: { background: 'var(--bg)', border: '2px solid var(--border)', borderRadius: 10, width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' },
  ...
  mainCard: { background: 'var(--bg-card)', borderRadius: 16, padding: 24, border: '2px solid var(--border)', textAlign: 'center' },
