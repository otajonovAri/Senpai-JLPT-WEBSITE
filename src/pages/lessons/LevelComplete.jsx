...
const styles = {
  ...
  ring: { width: 120, height: 120, borderRadius: '50%', background: 'linear-gradient(135deg, var(--medal-gold), var(--primary))', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 0 40px rgba(255,215,0,0.3), 0 0 0 10px rgba(255,215,0,0.08)', marginBottom: 20 },
