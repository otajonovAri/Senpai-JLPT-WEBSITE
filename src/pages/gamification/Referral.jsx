...
const styles = {
  ...
  card: { background: 'var(--bg-card)', borderRadius: 14, padding: 18, border: '2px solid var(--border)' },
  ...
  input: { flex: 1, padding: '10px 14px', borderRadius: 8, border: '2px solid var(--border)', fontSize: 14, outline: 'none' },
