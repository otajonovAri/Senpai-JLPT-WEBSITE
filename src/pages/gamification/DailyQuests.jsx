...
const styles = {
  ...
  summaryCard: { display: 'flex', alignItems: 'center', gap: 14, padding: '16px 18px', background: 'var(--bg-card)', borderRadius: 14, border: '2px solid var(--border)' },
  ...
  card: { display: 'flex', alignItems: 'center', gap: 12, padding: '14px 16px', background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)' },
