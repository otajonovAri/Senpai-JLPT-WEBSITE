...
const styles = {
  ...
  addCard: { display: 'flex', gap: 8, padding: 12, background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)', flexWrap: 'wrap' },
  addInput: { flex: 1, padding: '8px 12px', borderRadius: 8, border: '2px solid var(--border)', fontSize: 13, outline: 'none' },
  ...
  card: { display: 'flex', alignItems: 'center', gap: 12, padding: '12px 14px', background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)', cursor: 'pointer' },
  ...
  empty: { textAlign: 'center', padding: 32, background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)' },
