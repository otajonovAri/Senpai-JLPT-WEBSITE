...
const styles = {
  ...
  leagueDot: { width: 40, height: 40, borderRadius: '50%', background: 'var(--bg-card)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, transition: 'all 0.2s', border: '2px solid var(--border)', cursor: 'pointer' },
  promoRow: { display: 'flex', gap: 8 },
  promoCard: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: 10, background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)' },
  list: { display: 'flex', flexDirection: 'column', gap: 5 },
  row: { display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)' },
