...
const styles = {
  ...
  profileCard: { textAlign: 'center', padding: '24px 20px', background: 'var(--bg-card)', borderRadius: 16, border: '2px solid var(--border)' },
  ...
  statCard: { textAlign: 'center', padding: 14, background: 'var(--bg-card)', borderRadius: 12, border: '2px solid var(--border)' },
